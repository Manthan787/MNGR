...
$(document).ready(function() {
	...
	$('#contact-form').submit(function(event) {
		...
		var loading = $('<div class="alert alert-info">' + "Processing your message..." + '</div>');
		// Add the loading div while processing the input
		$('#contact-form').append(loading);
		...
		var formData = {
			...
			'subject' 	    : $('input#contact-input-subject').val(),
		...
		$.ajax({
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					// Remove the loading div once the input has been processed successfully
					loading.remove();
